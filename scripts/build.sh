...
readonly GIT_AUTHOR="gclm,bestrui"
...
# Build flags
readonly LDFLAGS="-X 'github.com/gclm/octopus/internal/conf.Version=${GIT_VERSION}' \
                  -X 'github.com/gclm/octopus/internal/conf.BuildTime=${BUILD_TIME}' \
                  -X 'github.com/gclm/octopus/internal/conf.Author=${GIT_AUTHOR}' \
                  -X 'github.com/gclm/octopus/internal/conf.Commit=${COMMIT_ID}' \
                  -s -w"
